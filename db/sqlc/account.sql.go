...
SELECT id, owner, currency, balance, created_at FROM accounts WHERE id = $1 LIMIT 1
`
...
SELECT id, owner, currency, balance, created_at FROM accounts ORDER BY id LIMIT $1 OFFSET $2
`
